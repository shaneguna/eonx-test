...
class ListsControllerTest extends ListTestCase
{
    ...
    {
        $this->patch('/mailchimp/lists/invalid-list-id');
    ...
    public function testUpdateListSuccessfully(): void
    {
        ...
        $this->patch(\sprintf('/mailchimp/lists/%s', $list['list_id']), ['permission_reminder' => 'updated']);
        $content = \json_decode($this->response->content(), true);
    ...
    public function testUpdateListValidationFailed(): void
    {
        ...
        $this->patch(\sprintf('/mailchimp/lists/%s', $list->getId()), ['visibility' => 'invalid']);
        $content = \json_decode($this->response->content(), true);
